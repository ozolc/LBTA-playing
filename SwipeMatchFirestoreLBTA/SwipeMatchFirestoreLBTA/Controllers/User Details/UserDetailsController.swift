...
class UserDetailsController: UIViewController, UIScrollViewDelegate {
    ...
    lazy var superLikeButton = self.createButton(image: #imageLiteral(resourceName: "boost_circle"), selector: #selector(handleDislike))
    ...
    fileprivate func setupBotomControls() {
